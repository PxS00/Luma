      ...
      <div>
        ...
        <div>
          <BtnExterno href={STORE_LINKS.play.href} target="_blank">
            <img src={STORE_LINKS.play.icon} alt={STORE_LINKS.play.alt} width={20} height={20} /> Abrir na Play Store
          </BtnExterno>{' '}
          <BtnExterno href={STORE_LINKS.app.href} target="_blank">
            <img src={STORE_LINKS.app.icon} alt={STORE_LINKS.app.alt} width={20} height={20} /> Abrir na App Store
          </BtnExterno>
        </div>
      </div>
