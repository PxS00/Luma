...
export { default as cadastrando } from '../img/passo-a-passo/cadastrando.png';
export { default as confirmacaoAno } from '../img/passo-a-passo/confirmacao-ano.jpg';
export { default as confirmacaoNomeMae } from '../img/passo-a-passo/confirmacao-nome-mae.jpg';
export { default as dadosContato } from '../img/passo-a-passo/dados-contato.png';
export { default as preenchendoCpf } from '../img/passo-a-passo/preenchimento-cpf.jpg';
export { default as senhaCadastro } from '../img/passo-a-passo/senha-cadastro.jpg';
...
export { default as Kelson } from '../img/integrantes/kelson-zhang.jpg';
export { default as Lucas } from '../img/integrantes/lucas-rossoni.png';
