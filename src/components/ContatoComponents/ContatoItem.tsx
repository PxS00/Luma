...
export default function ContatoItem({ item }: ContatoItemProps) {
          ...
          >
            ...
            {item.inPerson && (
              <div className='p-3 sm:p-4 grid grid-cols-1 sm:grid-cols-[160px_minmax(0,1fr)] gap-2 sm:gap-4 items-center'>
                <dt className='font-semibold text-sm sm:text-base text-fontPrimary'>Presencial:</dt>
            ...
            {item.email && (
              <div className='p-3 sm:p-4 grid grid-cols-1 sm:grid-cols-[160px_minmax(0,1fr)] gap-2 sm:gap-4 items-center'>
                <dt className='font-semibold text-sm sm:text-base text-fontPrimary'>E-mail:</dt>
  ...
  '
            ...
            {item.tel && (
              <div className='p-3 sm:p-4 grid grid-cols-1 sm:grid-cols-[160px_minmax(0,1fr)] gap-2 sm:gap-4 items-center'>
                <dt className='font-semibold text-sm sm:text-base text-fontPrimary'>Telefone:</dt>
                <dd className='text-sm sm:text-base'>
                  <BtnExterno
                    href={`tel:${item.tel}`}
                    target='_blank'
      ...
      '
            ...
            {item.schedule && (
              <div className='p-3 sm:p-4 grid grid-cols-1 sm:grid-cols-[160px_minmax(0,1fr)] gap-2 sm:gap-4 items-center'>
                ...
                <dd className='text-sm sm:text-base text-fontSecondary'>{item.schedule}</dd>
              </div>
            )}
            ...
            {item.externalLink && (
              <div className='p-3 sm:p-4 grid grid-cols-1 sm:grid-cols-[160px_minmax(0,1fr)] gap-2 sm:gap-4 items-center'>
                <dt className='font-semibold text-sm sm:text-base text-fontPrimary'>Link:</dt>
                <dd className='text-sm sm:text-base'>
                  <BtnExterno
